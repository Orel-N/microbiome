...
env.par <- c("Temperature_sea","Salinity", "Dissolved_Oxygen", "DOC", "TDN", "NO2_NO3", "PO4", "NH4", "C_N", "BA_FC", "BCP", "Chl_A", "SiO3")
...
env.par <- c("Temperature_sea","Salinity", "Dissolved_Oxygen", "DOC", "NO2_NO3", "PO4", "NH4")
...
BAC_20.env <- data.frame(sample_data(BAC_20.no.na)) [c("Temperature_sea","Salinity", "Dissolved_Oxygen", "DOC", "NO2_NO3", "PO4", "NH4")]
BAC_20.env <- as.data.frame(scale(BAC_20.env,center = FALSE, scale = TRUE))
