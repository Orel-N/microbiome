...
summary_table_20 <- filter(summary_table, Dataset == "2020")

write.table(summary_table, "./output_tables/16S_15_20_overview_table.txt" , sep = "\t", quote = F)
write.table(summary_table_20, "./output_tables/16S_2020_overview_table.txt" , sep = "\t", quote = F)
...
#Filter only Dataset 2020:
ps_20 <- subset_samples(ps, Dataset == "2020")
ps_20 <- prune_taxa(taxa_sums(ps_20)>0, ps_20)
ps_20

ps0_20 <- subset_samples(ps0, Dataset == "2020")
ps0_20 <- prune_taxa(taxa_sums(ps0_20)>0, ps0_20)
ps0_20

ps3_20 <- subset_samples(ps3, Dataset == "2020")
ps3_20 <- prune_taxa(taxa_sums(ps3_20)>0, ps3_20)
ps3_20
...
saveRDS(ps_20, "./data/phyloseqRaw20.RDS")
saveRDS(ps0_20, "./data/phyloseqTaxFiltered20.RDS")
saveRDS(ps3_20, "./data/phyloseqPrevFiltered20.RDS")
