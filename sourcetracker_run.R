source('./SourceTracker_nrestart_ndraws_100.R')
...
ST_results <- predict.sourcetracker(st,otus[test.ix,], alpha1=alpha1, alpha2=alpha2, rarefaction_depth=10000, full.results=TRUE)

save.image("ST_results.RData")

# Estimate leave-one-out source proportions in training data 
ST_results.train <- predict.sourcetracker(st, alpha1=alpha1, alpha2=alpha2, rarefaction_depth=10000, full.results=TRUE)
