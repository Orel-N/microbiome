...
all.data.a <- ggplot(data = all.data) +
  geom_bar(mapping = aes(x = Location, y = Temperature_sea, fill = Season), position = position_dodge2(), stat = 'identity', width = .5, show.legend = FALSE) +
  geom_point(mapping = aes(x = Location, y = Dissolved_Oxygen*4, shape = "Dissolved oxygen", group = Season), position = position_dodge2(width=.5), stat = 'identity') +
  ...
  theme_bw() +
  theme(legend.position = c(0.9, 0.97), plot.margin = unit(c(0,1,0,0), "lines"), legend.background = element_rect(colour="black", linetype = "solid"), 
...
all.data.b <- ggplot(data = all.data) +
  geom_point(mapping = aes(x = Location, y = Salinity, colour = Season), position = position_dodge2(width=.7), stat = 'identity', show.legend = FALSE) +
...
all.data.c <- ggplot(data = all.data) +
  geom_bar(mapping = aes(x = Location, y = DOC, fill = Season), stat = 'identity', width = .5, position = position_dodge2(), show.legend = FALSE) +
  geom_point(mapping = aes(x = Location, y = C_N*9, shape = "C/N", group = Season), position = position_dodge2(width=.5), stat = 'identity') +
...
all.data.d <- ggplot(data = all.data) +
  geom_bar(mapping = aes(x = Location, y = TDN, fill = Season), stat = 'identity', width = .5, position = position_dodge2(), show.legend = FALSE) +
...
all.data.e <- ggplot(data = all.data) +
  geom_bar(mapping = aes(x = Location, y = NH4, fill = Season), stat = 'identity', width = .5, position = position_dodge2(), show.legend = FALSE) +
  geom_point(aes(x = Location, y = NO2+NO3, shape = "NO2+NO3", group = Season), position = position_dodge2(width=.5), stat = 'identity') +
...
all.data.f <- ggplot(data = all.data) +
  geom_bar(mapping = aes(x = Location, y = PO4, fill = Season), stat = 'identity', width = .5, position = position_dodge2(), show.legend = FALSE) +
  geom_point(aes(x = Location, y = SiO3/5, shape = "SiO3", group = Season), position = position_dodge2(width=.5), stat = 'identity') +
...
all.data.g <- ggplot(data = all.data, aes(fill=Season)) +
...
all.data.h <- ggplot(data = all.data, aes(fill=Season)) +
  geom_bar(mapping = aes(x = Location, y = BCP), position = position_dodge(), stat = 'identity', width = .5, show.legend = FALSE) +
  geom_errorbar(mapping = aes(x = Location, ymin = BCP - BCP_STDEV, ymax = BCP + BCP_STDEV), position = position_dodge(width = .5), stat = 'identity', width = 0.25) +
